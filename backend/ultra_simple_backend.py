...
app = FastAPI(
    title="Finance GenAI Chatbot with Gemini",
...
# Initialize Google Gemini (support both GEMINI_API_KEY and GOOGLE_API_KEY)
...
async def root():
    return {
        "message": "Finance GenAI Chatbot API with Google Gemini",
        "status": "running",
...
if __name__ == "__main__":
    print("🚀 Starting Finance GenAI Chatbot with Google Gemini...")
    print("📊 Backend API: http://localhost:8000")
    print("📚 Docs: http://localhost:8000/docs")
    print("🔑 Make sure to set GEMINI_API_KEY in .env file")
    print("🆓 Gemini is FREE to use!")
    uvicorn.run("ultra_simple_backend:app", host="0.0.0.0", port=8000, reload=True)
